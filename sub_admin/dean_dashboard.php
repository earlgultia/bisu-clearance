...
<body>
            ...
            <div id="pending" class="tab-content <?php echo $active_tab == 'pending' ? 'active' : ''; ?>">
                <div class="section-card">
                    ...
                    <div class="clearance-status-nav" aria-label="Clearance status sections" style="margin-bottom: 2rem; position: sticky; top: 1rem; z-index: 30; display: grid; grid-template-columns: repeat(3, minmax(0, 1fr)); gap: 1rem;">
                        <a class="clearance-status-card" href="#pendingClearances" style="cursor: pointer; display: flex; justify-content: space-between; align-items: center; gap: 1rem; padding: 1.25rem; background: var(--card-bg); border: 1px solid var(--border-color); border-radius: 12px; text-decoration: none; color: var(--text-primary); box-shadow: var(--card-shadow);">
                            <span>
                                <span style="display: block; font-weight: 700; font-size: 1rem;">Pending</span>
                                <span style="display: block; font-size: 0.85rem; color: var(--text-secondary); margin-top: 0.25rem;">Awaiting dean review</span>
                            </span>
                        ...
                        <a class="clearance-status-card" href="#approvedClearances" style="cursor: pointer; display: flex; justify-content: space-between; align-items: center; gap: 1rem; padding: 1.25rem; background: var(--card-bg); border: 1px solid var(--border-color); border-radius: 12px; text-decoration: none; color: var(--text-primary); box-shadow: var(--card-shadow);">
                            <span>
                                <span style="display: block; font-weight: 700; font-size: 1rem;">Approved</span>
                                <span style="display: block; font-size: 0.85rem; color: var(--text-secondary); margin-top: 0.25rem;">Completed dean actions</span>
                            </span>
                        ...
                        <a class="clearance-status-card" href="#rejectedClearances" style="cursor: pointer; display: flex; justify-content: space-between; align-items: center; gap: 1rem; padding: 1.25rem; background: var(--card-bg); border: 1px solid var(--border-color); border-radius: 12px; text-decoration: none; color: var(--text-primary); box-shadow: var(--card-shadow);">
                            <span>
                                <span style="display: block; font-weight: 700; font-size: 1rem;">Rejected</span>
                                <span style="display: block; font-size: 0.85rem; color: var(--text-secondary); margin-top: 0.25rem;">Returned submissions</span>
                            </span>
                    ...
                    <div class="clearance-accordion-modern" style="display: flex; flex-direction: column; gap: 1rem;">
                        <details id="pendingClearances" class="clearance-section-modern" open style="background: var(--card-bg); border: 1px solid var(--border-color); border-radius: 16px; overflow: hidden; box-shadow: var(--card-shadow);">
                            <summary style="list-style: none; cursor: pointer; user-select: none; padding: 1.25rem 1.5rem;">
                                <div class="clearance-section-header-modern" style="display: flex; align-items: center; justify-content: space-between; gap: 1rem;">
                                    <div style="flex: 1;">
                                        ...
                                        <p style="margin: 0.25rem 0 0 0; font-size: 0.9rem; color: var(--text-secondary);">Awaiting dean review</p>
                                    </div>
                    ...
                    <?php else: ?>
                        ...
                        <details id="approvedClearances" class="clearance-section-modern" style="background: var(--card-bg); border: 1px solid var(--border-color); border-radius: 16px; overflow: hidden; box-shadow: var(--card-shadow);">
                            <summary style="list-style: none; cursor: pointer; user-select: none; padding: 1.25rem 1.5rem;">
                                <div class="clearance-section-header-modern" style="display: flex; align-items: center; justify-content: space-between; gap: 1rem;">
                                    <div style="flex: 1;">
                                        <h3 style="margin: 0; font-size: 1.1rem; font-weight: 700; color: var(--text-primary);">Approved Clearances</h3>
                                        <p style="margin: 0.25rem 0 0 0; font-size: 0.9rem; color: var(--text-secondary);">Completed dean actions</p>
                                    </div>
                                    <div style="display: flex; align-items: center; gap: 0.75rem;">
                            ...
                            <div class="clearance-section-content-modern" style="padding: 0 1.5rem 1.5rem 1.5rem;">
                                <?php if (empty($approved_clearances)): ?>
                                        <div class="empty-state">
                                            ...
                                            <p>Approved dean records will appear here.</p>
                                        </div>
                                <?php else: ?>
                                        <div class="table-responsive">
                                                ...
                                                <tbody>
                                                    <?php foreach ($approved_clearances as $approved_item): ?>
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <div class="pending-detail-stack">
                                                                        <span class="type-badge"><?php echo htmlspecialchars(ucfirst($approved_item['clearance_type'] ?? 'dean')); ?></span>
                                                                        <div class="pending-meta"><?php echo !empty($approved_item['lacking_comment']) ? htmlspecialchars($approved_item['lacking_comment']) : 'Approved by dean'; ?></div>
                                                                    </div>
                                                                </td>
                                                                <td>
                                                                    ...
                                                                    <div class="pending-meta"><?php echo htmlspecialchars(trim(($approved_item['processed_fname'] ?? '') . ' ' . ($approved_item['processed_lname'] ?? '')) ?: 'Dean'); ?></div>
                                                                </td>
                        ...
                        <details id="rejectedClearances" class="clearance-section-modern" style="background: var(--card-bg); border: 1px solid var(--border-color); border-radius: 16px; overflow: hidden; box-shadow: var(--card-shadow);">
                            <summary style="list-style: none; cursor: pointer; user-select: none; padding: 1.25rem 1.5rem;">
                                <div class="clearance-section-header-modern" style="display: flex; align-items: center; justify-content: space-between; gap: 1rem;">
                                    <div style="flex: 1;">
                                        <h3 style="margin: 0; font-size: 1.1rem; font-weight: 700; color: var(--text-primary);">Rejected Clearances</h3>
                                        <p style="margin: 0.25rem 0 0 0; font-size: 0.9rem; color: var(--text-secondary);">Returned dean submissions</p>
                                    </div>
                                    <div style="display: flex; align-items: center; gap: 0.75rem;">
                            ...
                            <div class="clearance-section-content-modern" style="padding: 0 1.5rem 1.5rem 1.5rem;">
                                <?php if (empty($rejected_clearances)): ?>
                                        <div class="empty-state">
                                            ...
                                            <p>Rejected dean records will appear here.</p>
                                        </div>
                                <?php else: ?>
                                        <div class="table-responsive">
                                            <table class="pending-table">
                                                ...
                                                <tbody>
                                                    <?php foreach ($rejected_clearances as $rejected_item): ?>
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <div class="pending-detail-stack">
                                                                        <span class="type-badge"><?php echo htmlspecialchars(ucfirst($rejected_item['clearance_type'] ?? 'dean')); ?></span>
                                                                        <div class="pending-meta"><?php echo !empty($rejected_item['lacking_comment']) ? htmlspecialchars($rejected_item['lacking_comment']) : 'Rejected by dean'; ?></div>
                                                                    </div>
                                                                </td>
                                                                <td>
                                                                    ...
                                                                    <div class="pending-meta"><?php echo htmlspecialchars(trim(($rejected_item['processed_fname'] ?? '') . ' ' . ($rejected_item['processed_lname'] ?? '')) ?: 'Dean'); ?></div>
                                                                </td>
    ...
    <script>
        ...
        const dashboardBackGuardKey = '__deanDashboardBackGuard';
